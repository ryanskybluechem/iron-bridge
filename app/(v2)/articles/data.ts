...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        html: "Two patterns repeat. Operators with strong businesses take too little out, and they hit their forties and discover their entire net worth is illiquid. Operators with thinner businesses take too much out, and underinvest in the very thing that funds the lifestyle.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        html: "What buyers actually examine, and what survives QOE, is rarely what sellers prepare for.",
      },
