    ...
    <>
      ...
      <section className="trust">
        <div className="trust-inner">
          <div className="trust-label">Built for operators running</div>
          <div className="trust-types">
            <span>Professional services</span>
            <span className="dot">·</span>
            <span>Construction &amp; trades</span>
            <span className="dot">·</span>
            <span>Healthcare practices</span>
            <span className="dot">·</span>
          ...
          <div className="manifesto-grid">
            ...
            <div>
              ...
              <p className="manifesto-tail">
                Iron Bridge gives business owners a CFO-grade tax projection
                by June 1st, then six months to execute against it. That&apos;s
                the entire game.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title">
              Three steps. Six months of leverage.
            </h2>
          </div>
      ...
      <section className="calculators" id="calculators">
        <div className="container">
          ...
          <div className="calc-disclaimer">
            Illustrative. Real engagements model your actual books,
            depreciation schedules, entity structure, and state-specific code.{" "}
      ...
      <section className="services" id="services">
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title">
              Beyond accounting. Strategic finance.
            </h2>
          </div>
      ...
      <section className="team" id="team">
        <div className="container">
          <div className="section-head">
            ...
            <h2 className="section-title">
              Strategists who built operating businesses first.
            </h2>
          </div>
            ...
            <div className="team-card team-card-cta">
              <div className="team-cta-inner">
                ...
                <p>
                  ...
                  engagements start with a paid scoping call and a delivered
                  tax projection within 30 days.
                </p>
      ...
      <section className="articles" id="articles">
        <div className="container">
          ...
          <div className="articles-grid">
            {articles.map((a, i) => (
              <a className="article-card" key={i} href="#">
